...
classdef Hitchcock1967_simpleGameEngine < handle
    properties
    ...
    methods
        function obj = Hitchcock1967_simpleGameEngine(sprites_fname, sprite_height, sprite_width, zoom, background_color)
            % simpleGameEngine
            % Input: 
